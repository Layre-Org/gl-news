...
function News({ size }: NewsProps) {
  ...
  return (
    <Link to="/news">
      <div className="border rounded-md w-full aspect-[2] p-4 flex gap-4 transition hover:scale-[1.01]">
        <div className="w-1/2">
          <img
        ...
        <div className="w-1/2 flex flex-col justify-between">
          <div className="flex flex-col gap-4">
            ...
            <p className={text()}>
              ...
              revelam que “mais de 20” 9600X e “mais de 30” 9700X foram
              adquiridas em sua plataforma – mostrando que ao menos na Europa
              não está havendo muita procura pelos hardwares.
            </p>
          </div>
